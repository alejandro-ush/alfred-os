    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day_selected:
                    "bg-blue-600 text-white hover:bg-blue-600 hover:text-white focus:bg-blue-600 focus:text-white rounded-full shadow-md",
            ...
            // Eliminamos 'components' porque Shadcn v9 ya trae los iconos por defecto o los maneja via CSS
            {...props}
        />
    )
}
